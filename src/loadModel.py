...
def model_decision(model, player_value, dealer_card,dealer_estimated_value):
    ...
    d = {'dealer_card':[dealer_card], 'init_hand':[player_value], 'hit':[1],'dealer_estimated_value':[dealer_estimated_value]} 
...
action = ['stay', 'hit']
print(action[model_decision(new_model, 15, 8,17)])
print(action[model_decision(new_model, 17, 8,12)])
print(action[model_decision(new_model, 16, 10,20)])
print(action[model_decision(new_model, 11, 10,19)])
